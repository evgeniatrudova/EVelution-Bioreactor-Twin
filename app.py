...
with st.expander("Mathematical Formula & Academic Explanation"):
    ...
    st.markdown("""
    **Academic Explanation:** Standard bioprocessing often conflates total nanoparticle count with successful biogenesis. The Yield-to-Value Bridge mathematically deconstructs the raw NTA scatter count ($C_{harvest}$). 
