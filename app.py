...
with st.expander("Explore Theory"):
    ...
    t1.markdown("""
    The growth rate ($\mu$) is governed by Monod Kinetics. As substrate ($S$) is consumed, 
    the growth rate approaches zero, signaling the entry into the stationary phase. 
    In fed-batch processes, maintaining a stable $\mu$ is key to preventing 
